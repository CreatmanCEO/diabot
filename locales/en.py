...
START_WELCOME = (
    "👋 Hi, {name}!\n\n"
    "I'm <b>DiaBot</b> — your personal nutrition assistant.\n\n"
    "What I can do:\n"
    "📸 Recognize food from photos and calculate calories, protein, fat, carbs\n"
    "🔢 Count bread units for diabetes management\n"
    "📊 Keep a food diary with daily nutrition targets\n"
    "💉 Track blood sugar readings\n\n"
    "Let's set up quickly — this will take less than a minute!\n\n"
    "<i>By continuing, you agree to sending food photos to an AI service "
    "for recognition. Details: /privacy</i>"
)
CONSENT_AGREE = "👌 Let's set up!"
...
ONBOARDING_COMPLETE = (
    ...
    "✏️ Or just type what you ate\n\n"
    "The buttons below help with your diary and other features.\n"
    "Settings are always available via ⚙️ Menu."
)
