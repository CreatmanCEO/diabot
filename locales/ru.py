...
# --- Onboarding ---
START_WELCOME = (
    "👋 Привет, {name}! Я <b>DiaBot</b> — твой помощник "
    "для подсчёта углеводов и КБЖУ по фото еды.\n\n"
    "Я здесь, чтобы помочь тебе следить за питанием — "
    "просто отправь фото еды, а я распознаю продукты, "
